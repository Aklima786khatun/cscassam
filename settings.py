...
# 7. STATIC FILES (CLEANED VERSION)
STATIC_URL = "static/"
STATIC_URLS = BASE_DIR / 'static'

MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
# STATICFILES_DIRS should only point to folders NOT inside your apps.
# If you have a folder named 'static' in your root directory, keep this:
